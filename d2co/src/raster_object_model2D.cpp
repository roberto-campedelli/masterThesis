...
void RasterObjectModel2D::updateRaster()
{
...
const std::vector< cv::Point3f >& RasterObjectModel2D::getPrecomputedPoints(int idx) const
{
  std::cerr<<"IMPLEMENT ME!!"<<std::endl;
  exit(-1);
}

const std::vector< cv::Point3f >& RasterObjectModel2D::getPrecomputedDPoints(int idx) const
{
  std::cerr<<"IMPLEMENT ME!!"<<std::endl;
  exit(-1);
}

const std::vector< cv::Vec6f >& RasterObjectModel2D::getPrecomputedSegments(int idx) const
{
  std::cerr<<"IMPLEMENT ME!!"<<std::endl;
  exit(-1);
}

const std::vector< cv::Point3f >& RasterObjectModel2D::getPrecomputedDSegments(int idx) const
{
  std::cerr<<"IMPLEMENT ME!!"<<std::endl;
  exit(-1);
}
...
// TODO
void RasterObjectModel2D::retreiveModel( int idx )
{
  std::cerr<<"IMPLEMENT ME!!"<<std::endl;
  exit(-1);
}
...
// TODO
void RasterObjectModel2D::storeModel()
{
  std::cerr<<"IMPLEMENT ME!!"<<std::endl;
  exit(-1);
}

void RasterObjectModel2D::loadPrecomputedModels ( cv::FileStorage& fs )
{
  std::cerr<<"IMPLEMENT ME!!"<<std::endl;
  exit(-1);
}

void RasterObjectModel2D::savePrecomputedModels ( cv::FileStorage& fs ) const
{
  std::cerr<<"IMPLEMENT ME!!"<<std::endl;
  exit(-1);
}
